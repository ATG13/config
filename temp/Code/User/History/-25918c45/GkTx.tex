...
\includegraphics[scale=0.90]{young}
Fig1: Diagrama tensi\'on - deformaci\'on: el m\'odulo de elasticidad es la tangente en cada punto.
...
\includegraphics[scale=0.70]{sigma}

Fig2: Gráfica de Newtons aplicados contra cambio de longitud en el objeto.Se puede observar que la fuerza aplicada deforma de manera casi inapreciable el objeto.
